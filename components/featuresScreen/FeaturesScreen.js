  ...
  return (
    <div className={classes.content}>
      ...
      <div className={classes.block}>
        ...
        <div className={classes.description}>
          Get the capital you need from investors and partners in a single step.
          No deck, no meetings, no presentations. The future of access to
          capital is now.
        </div>
      </div>
      <div className={classes.block}>
        ...
        <div className={classes.description}>
          ...
          equity to raise capital is the most expensive form of capital when you
          are a growing company (that’s why VCs love it). Pando finance gives
          projects a cheaper alternative.
        </div>
      </div>
      <div className={classes.block}>
        <h1 className={classes.heading}>
